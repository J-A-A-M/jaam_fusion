...
function updateAlertsInfo() {
    ...
    fetch('/alerts-info')
        ...
        .then(data => {
            ...
            const alertTypes = [
                {key: 'air', label: 'Повітряна тривога (високий рівень)',
                ...
                {key: 'air_low', label: 'Повітряна тривога (низький рівень)',
                 icon: '<svg class="alert-detail-icon" viewBox="0 0 38 38" fill="none"><defs><clipPath id="clip0_air_low"><rect width="24" height="24" fill="white" transform="translate(7 7)"/></clipPath></defs><circle cx="19" cy="19" r="19" fill="#E6CD40"/><g clip-path="url(#clip0_air_low)"><path fill-rule="evenodd" clip-rule="evenodd" d="M23.1813 12.3365L23.4098 8.798L24.6992 7.50708L25.8692 9.64465L23.1813 12.3365ZM10.161 23.9349C8.82995 25.6952 8.22721 27.0553 7.92452 28.0985C7.54354 29.4114 8.58945 30.4574 9.90208 30.0752C10.9451 29.7716 12.3049 29.167 13.8817 27.9826C14.69 27.3603 15.3494 26.7923 16.0747 26.0659L11.935 21.9264C11.2079 22.6546 10.6339 23.3054 10.161 23.9349ZM29.2034 14.5938L25.6678 14.8229L28.356 12.1295L30.4931 13.3026L29.2034 14.5938ZM19.9385 13.9233L12.4869 21.3745L16.6267 25.514L24.0782 18.0629L19.9385 13.9233Z" fill="#141921"/></g></svg>'},
                ...
                {key: 'urban', label: 'Вуличні бої', 
                 ...
                 {key: 'chemical', label: 'Хімічна загроза', 
                 ...
                 {key: 'nuclear', label: 'Ядерна загроза', 
                 ...
                 {key: 'drones', label: 'Загроза ударних БПЛА', 
                 ...
                 {key: 'missiles', label: 'Загроза крилатих та авіаційних ракет', 
                 icon: '<svg class="alert-detail-icon" viewBox="0 0 24 24"><path d="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z"/></svg>'},
                 {key: 'kab', label: 'Загроза КАБ', 
                 icon: '<svg class="alert-detail-icon" viewBox="0 0 24 24"><path d="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z"/></svg>'},
                 {key: 'ballistic', label: 'Загроза балістичних ракет', 
                 icon: '<svg class="alert-detail-icon" viewBox="0 0 24 24"><path d="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z"/></svg>'},
...
function renderPasswordControl(ctrl) {
...
function renderControl(ctrl, lists) {
    ...
    if (type === 'password') {
        return renderPasswordControl(ctrl);
    }
