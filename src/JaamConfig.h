...
const RegionLedMapEntry REGION_MAP_LED[MAX_REGIONS] = {
    ...
    { 36,   { 142, 143, 145 },  3 },    // Вінницький район
    ...
    { 59,   { 206 , 208 , 224, 226}, 4 },    // Житомирський район
    ...
    { 68,   { 171, 173 }, 2 },    // Івано-Франківський район
    ...
    { 81,   { 53 , 61 , 88 },  3 },    // Кропивницький район
    ...
    { 112,  { 221 , 252 , 254 }, 3 },    // Рівненський район
    ...
    { 114,  { 195 , 197 , 234 }, 3 },    // Сумський район
    ...
    { 119,  { 180 , 182 , 214 }, 3 },    // Тернопільський район
    ...
    { 134,  { 146 , 183 , 185 , 210 , 211 },  5 },    // Хмельницький район
    ...
    { 152,  { 103 , 105 , 138},  3 },    // Черкаський район
    ...
    { 137,  { 150 , 152 },  2 },    // Чернівецький район
    ...
    { 140,  { 245 , 246 , 247 }, 3 },    // Чернігівський район
