...
const RegionLedMapEntry REGION_MAP_LED[MAX_REGIONS] = {
    ...
    // Запорізька область та її райони
    { 12,   { 24, 25, 26, 39, 40, 41, 45, 46, 47, 48 }, 10 },    // Запорізька область
    ...
    // Харківська область та її райони
    { 22,   { 110, 111, 113, 114, 123, 124, 125, 126, 127, 128, 129, 130 }, 12 },    // Харківська область
