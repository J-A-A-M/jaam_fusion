...
const RegionLedMapEntry REGION_MAP_LED[MAX_REGIONS] = {
    ...
    { 632,  { 171 }, 1 },    // м. Івано-Франківськ та Івано-Франківська територіальна громада
    ...
    { 83,   { 89 },  1 },    // м. Кропивницький та Кропивницька територіальна громада
    ...
    { 1473, { 151 }, 1 },   // м. Чернівці та Чернівецька територіальна громада
