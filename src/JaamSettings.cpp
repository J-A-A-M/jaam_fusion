...
std::map<Type, SettingItemInt> intSettings = {
    ...
    {ANIMATION_ALERT_ON_TYPE, {"aanot", 2}},
    {ANIMATION_ALERT_OFF_TYPE, {"aaoft",4}},
    {ANIMATION_DRONE_TYPE, {"adrt", 2}},
    {ANIMATION_RECON_DRONE_TYPE, {"ardrt", 2}},
    ...
    {ANIMATION_ALERT_OFF_CYCLE_TIME, {"aacft", 5000}},
    {ANIMATION_DRONE_CYCLE_TIME, {"adct", 700}},
    {ANIMATION_RECON_DRONE_CYCLE_TIME, {"ardct", 700}},
