...
Проєкт має кілька середовищ збірки в [platformio.ini](../../platformio.ini).
...
- [wiki/web-interface/sections/general.md](../web-interface/sections/general.md) — "Режим прошивки" та "Режим мапи"
- [wiki/web-interface/sections/firmware.md](../web-interface/sections/firmware.md) — OTA‑оновлення
