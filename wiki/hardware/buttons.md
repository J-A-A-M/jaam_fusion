...
Налаштування кнопок виконуються у веб‑інтерфейсі в секції **"Апаратне забезпечення"**.
...
Режим **"Передати керування в Home Assistant"** означає, що натискання кнопки не виконує локальну дію, а відправляє подію в HA через API.
