...
!!! warning
    Якщо пароль залишити порожнім — вхід через форму логіну буде неможливим, навіть якщо автентифікацію увімкнено. Встановіть пароль перед активацією цієї функції.

!!! tip
    Рекомендований пароль: мінімум 8 символів, велика та мала літера, цифра.
...
!!! note
    Токен генерується при кожному завантаженні пристрою і є дійсним до наступного перезавантаження. Після входу встановіть новий пароль у налаштуваннях.
