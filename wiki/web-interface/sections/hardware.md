...
!!! tip
    Загальні принципи підключення та живлення див. у [wiki/hardware/led-mapping.md](../../hardware/led-mapping.md).
...
- Детальніше: [wiki/web-interface/sections/sound.md](sound.md)
