...
!!! note
    Для профілю **Плата JAAM 2.1** прошивка має особливість роботи із сенсором освітлення BH1750 (активація через GPIO19). Детальніше: [Сенсори](../hardware/sensors.md).
...
- Динамік (buzzer) та апаратний вимикач.
