...
*На дисплеї — назва WiFi мережі для підключення*

![IP-адреса порталу на дисплеї](../assets/images/first-config/wifi-ip-display.png){ width="500" }

*На дисплеї — IP-адреса captive portal*
...
2. Браузер автоматично відкриє сторінку налаштування WiFi (captive portal). Якщо не відкрилась — перейдіть за IP-адресою, яку показує дисплей
    ...
    ![Сторінка налаштування WiFi](../assets/images/first-config/wifi-portal.png){ width="400" }

    *Сторінка налаштування WiFi з доступними мережами після сканування*

3. Сторінка автоматично просканує доступні мережі та покаже їх список. За потреби можна повторно просканувати кнопкою **"Сканувати знову"**
4. Оберіть свою мережу (або введіть у поле SSID) та введіть пароль

    ![Введення пароля та збереження](../assets/images/first-config/wifi-select-network.png){ width="400" }

    *Введіть пароль та натисніть «Зберегти та підключити»*

5. Натисніть **"Зберегти та підключити"** — пристрій збереже дані і перезавантажиться

    ![Підтвердження збереження у браузері](../assets/images/first-config/wifi-save-confirmation-web.png){ width="400" }

    *Браузер показує підтвердження збереження і повідомляє про перезавантаження*

    ![Підтвердження збереження на дисплеї](../assets/images/first-config/wifi-save-confirmation.png){ width="500" }

    *На дисплеї — підтвердження збереження мережі*
...
4. Ви потрапите до головної сторінки веб-інтерфейсу
    ...
    *IP-адресу можна побачити на дисплеї після підключення до мережі*
